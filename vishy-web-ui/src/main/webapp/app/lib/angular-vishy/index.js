...
(function (angular) {
    ...
    angular.module('angular-vishy.config')
        ...
        .value('tbkVishyDefaultConfig', {
            projectId: 'YOUR_PROJECT_VISHY_ID',   // String (required always)
            experimentId: 'YOUR_EXPERIMENT_VISHY_ID',   // String (optional always)
        ...
        .provider('tbkVishyConfig', [function () {
            ...
            this.experimentId = function (experimentId) {
